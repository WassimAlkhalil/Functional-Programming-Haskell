...
/* package mean-0.0.0.0 */
#ifndef VERSION_mean
#define VERSION_mean "0.0.0.0"
#endif /* VERSION_mean */
#ifndef MIN_VERSION_mean
#define MIN_VERSION_mean(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_mean */
...
#define CURRENT_COMPONENT_ID "mean-0.0.0.0-inplace-mean"
